...
const lineLimits: Record<string, number> = {
  ...
  "app/src/routes/channelPlaylistRoutes.ts": 201,
  ...
  "ui/src/components/settings/SettingsDisplayView.tsx": 610,
