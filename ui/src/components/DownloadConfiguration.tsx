...
export default function DownloadConfiguration() {
  ...
  return <div className="dl-config">
    ...
    <SettingsSection title={tx("YouTube access cookies", "Cookies dostępu do YouTube", "YouTube-Zugriffscookies")} description={tx("Only needed for content your YouTube account can access, such as age-restricted or members-only videos.", "Potrzebne tylko do treści dostępnych dla Twojego konta, np. z ograniczeniem wieku lub dla wspierających.", "Nur für Inhalte nötig, auf die dein YouTube-Konto Zugriff hat.")}>
