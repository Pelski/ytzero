...
export const pl: Locale = {
  messages: {
    ...
    close: "Zamknij",
    profilesHint: "Każdy profil ma własne subskrypcje, stan oglądania, playlisty, tagi i ustawienia. Kanały subskrybowane przez kilka profili są i tak pobierane raz.",
