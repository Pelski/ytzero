...
export const de: Locale = {
  messages: {
    ...
    close: "Schließen",
    profilesHint: "Jedes Profil hat eigene Abos, Wiedergabestatus, Playlists, Tags und Einstellungen. Von mehreren Profilen abonnierte Kanäle werden trotzdem nur einmal abgerufen.",
